package de.neuromechanics.pathfinder;

import java.io.Serializable;
import java.util.ArrayList;
import java.util.Collections;

import de.neuromechanics.pathfinder.heuristics.ClosestHeuristic;
...
public class AStarPathFinder implements IPathFinder, Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5124290505987544430L;
	...
	public AStarPathFinder(ITileBasedMap map, int maxSearchDistance, 
						   boolean allowDiagMovement, IAStarHeuristic heuristic) {
	...
	/**
	 * @see IPathFinder#findPath(IMover, int, int, int, int)
	 */
	 ...
	 */
	protected boolean isValidLocation(IMover mover, int sx, int sy, int x, int y) {
	 ...
	 */
	public float getMovementCost(IMover mover, int sx, int sy, int tx, int ty) {
	 ...
	 */
	public float getHeuristicCost(IMover mover, int x, int y, int tx, int ty) {
	...
	private class SortedList implements Serializable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -3499542742251668262L;
	...
	private class Node implements Comparable, Serializable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -1783902571475653008L;
